...
export default function Profile({ profile, onLogout, onUpdate, stats }) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
        ...
        {isEditing ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            ...
            <div className="p-3 bg-slate-50 rounded-2xl flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] text-slate-400 block font-semibold">GÜVENLİK PIN KODU</span>
      ...
      {/* PIN Security Details Card */}
      <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm space-y-4">
        <div className="flex justify-between items-center border-b border-slate-50 pb-3">
          <h3 className="font-bold text-slate-800 text-sm">PIN Kodu Doğrulaması (2FA)</h3>
        ...
        <p className="text-xs text-slate-500 leading-relaxed">
          Hesabınız cihaz ve IP tanıma sistemiyle korunmaktadır. Aynı konumdan girildiğinde otomatik açılır; farklı bir cihaz veya ağdan giriş yapıldığında ise kayıt sırasında oluşturduğunuz 6 haneli Güvenlik PIN kodunu girmeniz istenir.
        </p>
      </div>
